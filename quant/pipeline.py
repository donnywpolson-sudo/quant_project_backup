...
def run_pipeline(data_path: str, out_manifest: str='artifacts/manifest_mvp.json', prod_mode: bool=False, top_k: int=20, discovery_run: bool=True, bootstrap_folds: int=1):
    pass
    ...
    manifest = {'version': 'mvp-1', 'feature_names': selected, 'selection_method': 'baseline_yaml_priority', 'baseline_matrix_path': baseline_out, 'prod_mode': bool(prod_mode)}
    if discovery_run:
        ...
        manifest.update({'selection_model': 'ExtraTreesRegressor', 'selection_params': {'n_estimators': 100, 'max_depth': 8, 'bootstrap_folds': n_folds}, 'frozen_features': frozen})
