...
DEFAULT_OUT_ROOT = _SCRIPT_DIR if _SCRIPT_DIR.name == "L1_mbp1" else _SCRIPT_DIR / "L1_mbp1"
...
def market_output_dir(out_root: Path, market: str) -> Path:
    # Example:
    #   data/L1_mbp1/CL/CL_front_mbp1_2025-06-01_2025-06-02.dbn.zst
    return out_root / market
...
def download_chunk(
    ...
    out_dir = market_output_dir(out_root, market)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=f"Output root directory. Files are written to <out>/<market>. Default: {DEFAULT_OUT_ROOT}",
    )
